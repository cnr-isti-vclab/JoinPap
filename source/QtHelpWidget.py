...
class QtHelpWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.gridlayout2.addWidget(QLabel("Active Pan/Zoom Tool"), 0, 0)
        self.gridlayout2.addWidget(QLabel("Active Freehand Tool"), 1, 0)
        self.gridlayout2.addWidget(QLabel("Active Edit Border Tool"), 2, 0)
        self.gridlayout2.addWidget(QLabel("AI suggestion"), 3, 0)
        ...
        layout_V1.addWidget(self.groupbox_tool)

        main_layout = QHBoxLayout()
        main_layout.setAlignment(Qt.AlignRight)
        main_layout.addLayout(layout_V1)
        main_layout.addWidget(self.groupbox_commands)
